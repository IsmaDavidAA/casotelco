...
USING csv
OPTIONS (path "/FileStore/tables/churn_Operacion_1.csv", header "true")
...
DROP TABLE IF EXISTS aux_telco_operacion1F;
...
USING csv
OPTIONS (path "/FileStore/tables/churn_Operacion_2.csv", header "true")
...
-- MAGIC
-- MAGIC telco1_pd = spark.read.csv("/FileStore/tables/churn_Operacion_1.csv", header="true", inferSchema="true").toPandas()
